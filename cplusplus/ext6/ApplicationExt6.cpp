...
ApplicationExt6::ApplicationExt6()
{
}

CoffeeHouseWithSupplyManager* ApplicationExt6::build()
{
	CoffeeHouseWithSupplyManager* model = new CoffeeHouseWithSupplyManager();
	...
	model->addSupplyManager(new SupplyManager(model));
